...
public class UserUI extends JFrame {
    ...
    private static final long serialVersionUID = -5651758338826222303L;
    ...
    private JPanel makeOuFieldsPanel() {
        ...
        hGroup.addGroup(layout.createParallelGroup().addComponent(usernameLabel).addComponent(passwordLabel).addComponent(ouLabel).addComponent(typeLabel));
        hGroup.addGroup(layout.createParallelGroup().addComponent(username).addComponent(password).addComponent(ou).addComponent(type));
        ...
        vGroup.addGroup(layout.createParallelGroup(Alignment.BASELINE)
                .addComponent(ouLabel).addComponent(ou));
    ...
    private class ButtonListener implements ActionListener {
        ...
        private void savePressed() {
            if (username.getText() != null && !username.getText().equals("")) {
                User u = new User(username.getText(), password.getText(), ou.getText(), type.getText());
                data.add(u);
            }
